# Versioning Guidelines for your Plugin

Once you are ready to create a formal 'released' version of your plugin to your users, you'll want to think about the versioning structure you'll use.
...
If you're interested in date-based versioning, the structure is as follows:

`YYYY.MM.PP`

With `YYYY` and `MM` representing year and month of the release date, respectively, and `PP` representing the patch version (if applicable).
...
More information on creating a release on Github can be found under [creating a new release of your plugin on GitHub](release-on-gh).
